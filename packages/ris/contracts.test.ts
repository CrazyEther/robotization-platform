...
const sim:SimulationResult={engine:'SimPy',engineVersion:'test',status:'complete',routeMeters:18,created:100,completed:100,backlog:0,throughputPerHour:12.5,meanQueueMinutes:1,robotUtilization:.7,distanceMeters:1800,energyKwh:10,chargingHours:0,warnings:[],inputHash:'fixture',wallTimeMs:10};
