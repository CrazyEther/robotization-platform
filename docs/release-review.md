...
- Playwright: 16 сквозных проверок desktop/mobile с реально работающим Python API, включая восемь повторных запусков и контроль блокировки ROI при неопределённости.
